  ...
  function Ca(t, e) {
    ...
    if (
      ((e._time || (e._initted && !e._dur)) &&
        ((r = za(t.rawTime(), e)),
        (!e._dur || Tt(0, e.totalDuration(), r) - e._tTime > V) &&
          e.render(r, !0)),
      ...
      function (t, e, r) {
        ...
        if (!_) {
          ...
          for (
            ...
            (a = (u % f) - i),
              (s = n - ((u / f) | 0)),
              (_[u] = o = T ? Math.abs("y" === T ? s : a) : G(a * a + s * s)),
              h < o && (h = o),
              o < l && (l = o);
          "random" === g && Ya(_),
            (_.max = h - l),
  ...
  var Yt = (function (n) {
    ...
    return (
      ...
      (e.addPause = function addPause(t, e, r) {
        ...
        return (
          (i.data = "isPause"), (this._hasPause = 1), Da(this, i, bt(this, t))
        );
      }),
  ...
  var Ut,
    ...
    jt = function _initTween(e, r) {
      ...
      if (
        ...
        for (
          e._pt = e._ptCache = 0, T = (A && t(T)) || (T && !A), n = 0;
          n < S.length;
          n++
        ) {
          if (
  ...
  var $t = (function (R) {
    function Tween(e, r, i, n) {
      ...
      if (
        ...
        if (
          ((r = a.vars),
          (o = a.timeline =
            new Yt({ data: "nested", defaults: x || {} })).kill(),
      ...
      return (
        !0 !== T ||
          B ||
          ((Ut = _assertThisInitialized(a)), I.killTweensOf(C), (Ut = 0)),
    ...
    return (
      ...
      (e.resetTo = function resetTo(t, e, r, i) {
        ...
        if (
          (this._initted || jt(this, o), (n = this._ease(o / this._dur)), s(t))
        ) {
          for (a in t)
            if (Yb(this, a, t[a], e ? e[a] : null, r, n, o))
              return this.resetTo(t, e, r, i);
    ...
    if (e.tween && e.tween._time === e.tween._dur) {
      ...
      if ("all" === o || !0 === o) (s.cssText = ""), (i = 1);
        ...
        for (n = (o = o.split(",")).length; -1 < --n; )
          (r = o[n]),
            Fe[r] && ((i = 1), (r = "transformOrigin" === r ? je : Ve)),
            Bd(a, r);
      i &&
        (Bd(a, Ve),
        u &&
  ...
  function Qd(t, e, r, i, n, a) {
    ...
    r
      ? l !== We &&
        ...
        (x = u))
      : ((w = (s = zd(t)).x + (~T[0].indexOf("%") ? (w / 100) * s.width : w)),
        (x = s.y + (~(T[1] || T[0]).indexOf("%") ? (x / 100) * s.height : x))),
      i || (!1 !== i && h.smooth)
        ? ((y = w - f),
          (b = x - d),
          (h.xOffset = _ + (y * c + b * g) - y),
  ...
  var le,
    ...
    He = function _parseTransform(t, e) {
      ...
      return (
        ...
        (r.zOrigin = parseFloat(L.split(" ")[2]) || 0) && (F[je] = Je(L)),
        ...
        for (d in (_e || wd(), e))
          if (
            ...
            if (
              ...
              if (
                m ||
                ((u || 0 === u) && (h || 0 === h) && !Ue.test(s) && d in w)
              )
                (u = u || 0),
                  (_ = (a + "").substr((h + "").length)) !==
                    (p = Ra(s) || (d in Y.units ? Y.units[d] : _)) &&
                    (h = Ed(t, d, a, p)),
                  (this._pt = new oe(
                    this._pt,
                    m ? v : w,
